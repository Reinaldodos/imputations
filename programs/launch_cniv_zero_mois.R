...
estimation_ngp <- response_median_predict(
  object = cniv, prediction_period = date_publication[date_publication <= date_ref], # in�galit� non stricte si z�ro mois de recul
  NR_list = NR_list, 
  product_var = "ngp", 
...
compute_coverage(
  ...
  NR_list = NR_list, output_dates = date_publication[date_publication <= date_ref], # in�galit� non stricte si z�ro mois de recul
  f = "E", 
